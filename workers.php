                        ...
                        <div class="col-6 col-sm-4">
                            <div class="header-top-account d-flex justify-content-end">
                                <div class="btn-group me-2">
                                    <div class="dropdown">
                                        <button class="btn btn-sm dropdown-toggle" type="button" id="account-button" data-bs-toggle="dropdown" aria-expanded="false">
                                        Аккаунт
                                        </button>
                        ...
                        <div class="row"> 
                            ...
                            if ($result->num_rows > 0) { 
                                while ($row = $result->fetch_assoc()) { 
                                    ...
                                    echo ' <a href="cart.html?trainingId=0&trainerId='. $row['id']. '" class="btn btn-outline-secondary add-to-form">'; 
                                    echo ' Записаться';
                                    echo ' </a>'; 
                                    echo ' </div>'; 
                                    echo ' </div>'; 
